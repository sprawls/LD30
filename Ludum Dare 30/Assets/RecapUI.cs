...
public class RecapUI : MonoBehaviour {
	...
	void OnGUI(){
		...
		GUI.Label (new Rect (0.82f * Screen.width, 0.42f * Screen.height, 0.01f * Screen.width, 0.1f * Screen.height), "200",menuStyle);
		GUI.Label (new Rect (0.82f * Screen.width, 0.48f * Screen.height, 0.01f * Screen.width, 0.1f * Screen.height), "350",menuStyle);
		GUI.Label (new Rect (0.82f * Screen.width, 0.54f * Screen.height, 0.01f * Screen.width, 0.1f * Screen.height), "600",menuStyle);
		GUI.Label (new Rect (0.82f * Screen.width, 0.60f * Screen.height, 0.01f * Screen.width, 0.1f * Screen.height), "650",menuStyle);
		...
		GUI.Label (new Rect (0.90f * Screen.width, 0.42f * Screen.height, 0.01f * Screen.width, 0.1f * Screen.height), "300",menuStyle);
		GUI.Label (new Rect (0.90f * Screen.width, 0.48f * Screen.height, 0.01f * Screen.width, 0.1f * Screen.height), "500",menuStyle);
		GUI.Label (new Rect (0.90f * Screen.width, 0.54f * Screen.height, 0.01f * Screen.width, 0.1f * Screen.height), "900",menuStyle);
		GUI.Label (new Rect (0.90f * Screen.width, 0.60f * Screen.height, 0.01f * Screen.width, 0.1f * Screen.height), "900",menuStyle);
